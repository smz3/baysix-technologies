...
only on a connection that registered it, and only `core/infra/db_guard.arm()`
...
Run: python db/migrations/045_write_guard_triggers.py
"""
import sqlite3
import sys
...
from core.infra import db_guard  # noqa: E402
