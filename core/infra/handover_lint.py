...
Usage
-----
  python core/infra/handover_lint.py <handover.md> [<handover2.md> ...]
...
from core.infra.db_path import DB_PATH  # noqa: E402,F401  (task 357: one canonical path)
...
def _citations_in(section: str, valid_ids: set[int]) -> bool:
    ...
    for m in ARTIFACT_RE.finditer(section):
        ...
        for home in ("", "mt5", "outputs", "research", "data"):
