"""Thin read-only CLI over the core/ getters — replaces the ad-hoc DB
...
USAGE:
    python core/gates/idea_cli.py prebrief ORB-001
    python core/gates/idea_cli.py gatecheck HMM-001
    python core/gates/idea_cli.py status ORB-002
"""
...
# resolves when invoked as `python core/gates/idea_cli.py ...`
sys.path.insert(0, str(Path(__file__).resolve().parents[2]))
from core.gates import pipeline, protocol
from core.lineage import agent_log, backlog, strategy_log
