...
1. Phase 0: Fix B2B cluster bug, validate OOS (sigma-are + sigma-lean)
2. Phase 1: Build adapters/gold/ in sigma-are (IC measurement)
3. Phase 2: Build DWX Connect bridge (sigma-mt5/brokers/darwinex-zero/)
