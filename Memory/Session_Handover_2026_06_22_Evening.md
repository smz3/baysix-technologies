...
- Three commits this session: `1ab6d66` (step 1), `e429049` (step 2), `bff733e` (steps 3+3b). Docs commit pending (see below).
...
- **Phase-4 docs (pending commit)** — [docs/reference/research_protocol.md](../docs/reference/research_protocol.md) rewritten → 4.0; 3.2/3.3 specs → [docs/specs/_archive/](../docs/specs/_archive/); [docs/reference/research_db_schema.md](../docs/reference/research_db_schema.md) updated (is_runs, dropped cols, gate 1-4, tester ledger); CLAUDE.md repo-layout + rule 8/8b → 4.0; `research/code/README.md` → subpackage index; moved-script doc paths fixed.
