...
research/code, because results are shared truth and must not fork per platform.

STAYED BEHIND in research/code/io on purpose: tester.py and fob_payload.py.
Six applied migrations (012/022/030/031/036 and research/code/__init__.py's
