...
so `from research.code import X` keeps working unchanged across the migrations, the
...
`from research.code.lineage import backlog` — a pure-`sqlite3` module with zero third-
...
research.code import X` still works — Python falls back to the module `__getattr__`
...
`from research.code import <sibling>` at their own top level from hitting a half-built
package. That ordering is no longer load-bearing: every module inside this package now
imports its siblings by fully-qualified subpackage path (`from research.code.gates
...
# `from research.code import <name>`; it is loaded on first touch, not at import time.
_LAZY_EXPORTS = {
    # leaf engine + ledgers
    "pipeline":             "research.code.gates.pipeline",
    "protocol":             "research.code.gates.protocol",
    "strategy_log":         "research.code.lineage.strategy_log",
    "agent_log":            "research.code.lineage.agent_log",
    "backlog":              "research.code.lineage.backlog",
    "db_init":              "research.code.infra.db_init",
    "execution":            "research.code.infra.execution",
    "arctic_io":            "research.code.io.arctic_io",
    # depend on the leaves above
    "tester":               "research.code.io.tester",
    "run_and_log":          "research.code.infra.run_and_log",
    "run_tracked":          "research.code.infra.run_tracked",
    "handover_lint":        "research.code.infra.handover_lint",
    ...
    "fetch_papers":         "research.code.io.fetch_papers",
    "extract_pdf":          "research.code.io.extract_pdf",
    "backfill_dissect_md":  "research.code.io.backfill_dissect_md",
}
