...
Four additive columns (the canonical DDL in research.code.tester._SCHEMA already
...
Run: python research/migrations/031_tester_zones_identity_consolidation.py
"""
import sys
