...
What this does — all additive, all idempotent:
  ...
  1. TASK 287 — tester_* DDL drift. `db_init.py` carried a SECOND, stale copy of the
     ...
     research/code/infra/schema_ledger.py and BOTH db_init.py and tester.py import it.
...
Run: python research/migrations/037_grw_schema.py
"""
import sqlite3
import sys
...
from research.code.infra.schema_ledger import SCHEMA_MT5, SCHEMA_GRW  # noqa: E402
