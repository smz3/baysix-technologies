...
from research.models.orb.equity_sim import (
    load_oos_trades, MIN_LOT, CONTRACT_OZ, LEVERAGE,
)
from research.models.orb.equity_sim_honest import (
    n_flips_to_target, TARGET_ER, WIN_R, START, N_PATHS, SEED,
)

_OUT = Path(__file__).resolve().parents[3] / "research" / "outputs" / "orb" / "dd_sizing"
ATR_WINDOW = 20
LOT_STEP = 0.01
